...
public interface Linker<T> {
  ...
  /**
   * Returns the index of your registered binders for your itemtt. The result should be in range of
   * {@code [0, one-to-multiple-binders.length)}.
   *
   * <p>Note: The argument of {@link OneToManyFlow#to(ItemVM[])} is the
   * one-to-multiple-binders.</p>
   *
   * @param position The position in items
   * @param t Your itemtt data
   * @return The index of your registered binders
   * @see OneToManyFlow#to(ItemVM[])
