...
public interface TypePool {
  ...
  /**
   * Registers a type class and its itemtt view binder.
   *
  ...
  /**
   * For getting index of the itemtt class. If the subclass is already registered,
  ...
  /**
   * Gets the itemtt view binder at the specified index.
   *
   * @param index the itemtt index
   * @return the itemtt class at the specified index
   * @throws IndexOutOfBoundsException if the index is out of range
   */
  @NonNull
