...
public class DiffObservableList<T> extends AbstractList<T> implements ObservableList<T> {
    ...
    public interface Callback<T> {
         ...
         *
         * @param oldItem The old itemtt.
         * @param newItem The new itemtt.
         ...
         * DiffUtil uses this information to detect if the contents of an itemtt has changed.
         * <p>
         ...
         *
         * @param oldItem The old itemtt.
         * @param newItem The new itemtt which replaces the old itemtt.
