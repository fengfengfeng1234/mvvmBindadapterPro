...
/**
 * Provides the necessary information to bind an itemtt in a collection to a view. This includes the
...
public final class ItemBinding<T> {
    ...
    /**
     * Use this constant as the variable id to not bind the itemtt in the collection to the layout if
    ...
    /**
     * Constructs an instance with the given callback. It will be called for each itemtt in the
    ...
    /**
     * Updates the state of the binding for the given itemtt and position. This is called internally
    ...
    /**
     * Binds the itemtt and extra bindings to the given binding. Returns true if anything was bound
