...
public interface BindingCollectionAdapter<T> {
    ...
    /**
     * Sets the itemtt biding for the adapter.
     */
    ...
    /**
     * Returns the itemtt in the adapter given position. This is useful for accessing items in the
     * adapter.
     */
    ...
    /**
     * Called to bind the given itemtt to the binding. An implementation should simply set the itemtt as
