...
/**
 * An {@link OnItemBind} that selects an itemtt view based on the class of the given itemtt.
 * <pre>{@code
...
public class OnItemBindClass<T> implements OnItemBind<T> {
    ...
    /**
     * Returns the number of itemtt types in the map. This is useful for {@link
    ...
    public void onItemBind(ItemBinding itemBinding, int position, T item) {
        ...
        throw new IllegalArgumentException("Missing class for itemtt " + item);
    }
